...
// */
//
//class  CarAdapterBrvah3 (data: ArrayList<MultiItemEntity>, private val selectChangeListener: SelectChangeListener) : BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder>(data) {
//
